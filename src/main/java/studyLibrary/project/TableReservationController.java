    ...
    public Node createTable(Table table){
        ...
        card.setOnMouseClicked(new EventHandler<MouseEvent>() {
            public void handle(MouseEvent event){
                if(table.getAvailability().equals("Available")){
                    if(student.getReservedTable() != null){
                        Table previouslyReservedTable = student.getReservedTable();
                        previouslyReservedTable.setAvailability("Available");
                        MainController.dbManager.updateTable(previouslyReservedTable);
                        rectangle.setFill(Color.web("#00ab41", 0.2));
                        rectangle.setStroke(Color.web("#00ff88"));
                    }
                ...
                else if(table.getAvailability().equals("Reserved") && student.getReservedTable() != null && student.getReservedTable().getTableNo() == table.getTableNo()){
